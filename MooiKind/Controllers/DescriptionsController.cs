...
namespace MooiKind.Controllers
{
    public class DescriptionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DescriptionID,Description1")] Description description)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DescriptionID,Description1")] Description description)
        {
            if (ModelState.IsValid)
            {
